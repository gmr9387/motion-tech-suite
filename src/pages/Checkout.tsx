                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Button
                        ...
                        onClick={() => toast({ title: "Apple Pay", description: "Apple Pay is not yet configured. Please use card payment." })}
                      >
                      ...
                      <Button
                        ...
                        variant="outline"
                        className="h-12 font-semibold gap-2"
                        onClick={() => toast({ title: "Google Pay", description: "Google Pay is not yet configured. Please use card payment." })}
                      >
